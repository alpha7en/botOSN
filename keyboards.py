...
l10 = InlineKeyboardButton("усики", callback_data='l10')
l11 = InlineKeyboardButton("очки", callback_data='l11')
l12 = InlineKeyboardButton("🤟АВТО-ГЕНЕРАТОР ЮМОРА🤟", callback_data='l12')
l_kb = InlineKeyboardMarkup(resize_keyboard=True, one_time_keyboard=True, row_width=2).add(l1, l3).add(l2).add(l4).add(
    l5, l6).add(l7).add(l8, l9).add(l10, l11).add(l12)
